"""Regression checks for the thread-algo-search-lab casebook."""
...
from casebook.harness import assert_expected, thread_algo_search_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(thread_algo_search_lab_summary(), assert_expected())
