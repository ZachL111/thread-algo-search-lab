...
thread-algo-search-lab is a OCaml project for algorithms. It focuses on this technical goal: Package an OCaml local lab for search analysis with capacity fixtures, allocation and spill reports, and documented operating limits.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 155, risk penalty 5, latency penalty 2, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
